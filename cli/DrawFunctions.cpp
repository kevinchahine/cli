...
namespace cli
{
	CLI_API void horizontalLine(Matrix& mat, const Point & p1, size_t width, const color::Color & color, bool doubleLines)
	{
	...
	CLI_API void verticalLine(Matrix& mat, const Point & p1, size_t height, const color::Color & color, bool doubleLines)
	{
	...
	CLI_API void rectangle(Matrix& mat, const Point & p1, const Point & p2, const color::Color & color, bool doubleLines)
	{
		Point origin{
			min(p1.row, p2.row),
			min(p1.col, p2.col)
	...
	CLI_API void rectangle(Matrix& mat, const Point & origin, const Size & size, const color::Color & color, bool doubleLines)
	{
